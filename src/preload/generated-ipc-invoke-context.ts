...
export const generatedIpcInvokeContext = {
  ...
  getInGame: async (...args: Parameters<typeof StatsProviderIntegrationController.prototype.getInGame>): Promise<ReturnType<typeof StatsProviderIntegrationController.prototype.getInGame>> => ipcRenderer.invoke('getInGame', ...args),
